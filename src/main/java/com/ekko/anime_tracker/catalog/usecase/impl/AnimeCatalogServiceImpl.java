...
class AnimeCatalogServiceImpl implements AnimeCatalogCommandService {
  ...
  public AnimeCatalogServiceImpl(
      AnimeRepository animeRepository,
      AnimeRequestMapper animeRequestMapper,
      SeasonRequestMapper seasonRequestMapper,
      EpisodeRequestMapper episodeRequestMapper) {
  ...
  public void patchAnime(Long animeId, PatchAnimeRequest request) {
    Anime anime =
        animeRepository
            ...
            .orElseThrow(
                () ->
                    new ResourceNotFoundException("Anime with id %d not found".formatted(animeId)));
  ...
  public void updateSeason(Long animeId, Long seasonId, UpdateSeasonRequest request) {
    ...
    season
        .getEpisodes()
        .addAll(request.episodes().stream().map(episodeRequestMapper::toDomain).toList());
  ...
  public void removeSeason(Long animeId, Long seasonId) {
    ...
    boolean removed = anime.getSeasons().removeIf(season -> season.getId().equals(seasonId));

    if (!removed) {
      throw new ResourceNotFoundException(
          "Season id %d not found in %s".formatted(seasonId, anime.getTitle()));
    }
  ...
  @Transactional
  @Override
  public void patchEpisode(
      Long animeId, Long seasonId, Long episodeId, PatchEpisodeRequest request) {
    Anime anime =
        animeRepository
            .findById(animeId)
            .orElseThrow(
  ...
  public void updateEpisode(
      Long animeId, Long seasonId, Long episodeId, UpdateEpisodeRequest request) {
    Anime anime =
        animeRepository
            .findById(animeId)
            .orElseThrow(
  ...
  public void removeEpisode(Long animeId, Long seasonId, Long episodeId) {
    ...
    boolean removed = season.getEpisodes().removeIf(episode -> episode.getId().equals(episodeId));
