...
public class CatalogCommandController {
  ...
  public CatalogCommandController(
      AnimeCatalogCommandService service, AnimeResponseMapper animeResponseMapper) {
  ...
  public ResponseEntity<AnimeResponse> createAnime(@Valid @RequestBody CreateAnimeRequest request) {
    ...
    return ResponseEntity.status(HttpStatus.CREATED).body(animeResponseMapper.toResponse(anime));
  }

  @PatchMapping("/animes/{animeId}")
  public ResponseEntity<String> patchAnime(
      @PathVariable Long animeId, @Valid @RequestBody PatchAnimeRequest request) {
  ...
  public ResponseEntity<String> updateAnime(
      @PathVariable Long animeId, @Valid @RequestBody UpdateAnimeRequest request) {
  ...
  public ResponseEntity<String> addSeason(
      @PathVariable Long animeId, @Valid @RequestBody CreateSeasonRequest request) {
  ...
  public ResponseEntity<String> patchSeason(
    ...
    return ResponseEntity.ok(
        "Season id %d patched successfully in Anime id %d".formatted(seasonId, animeId));
  }
  ...
  public ResponseEntity<String> updateSeason(
    ...
    return ResponseEntity.ok(
        "Season id %d updated successfully in Anime id %d".formatted(seasonId, animeId));
  }

  @DeleteMapping("/animes/{animeId}/seasons/{seasonId}")
  public ResponseEntity<String> deleteSeason(
      @PathVariable Long animeId, @PathVariable Long seasonId) {

    service.removeSeason(animeId, seasonId);
    return ResponseEntity.ok(
        "Season id %d deleted successfully from Anime id %d".formatted(seasonId, animeId));
  }
  ...
  public ResponseEntity<String> addEpisode(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(
            "Episode '%s' added successfully in Season id %d of Anime id %d"
                .formatted(request.title(), seasonId, animeId));
  }
  ...
  public ResponseEntity<String> patchEpisode(
    ...
    return ResponseEntity.ok(
        "Episode id %d patched successfully in Season id %d of Anime id %d"
  ...
  public ResponseEntity<String> updateEpisode(
    ...
    return ResponseEntity.ok(
        "Episode id %d updated successfully in Season id %d of Anime id %d"
            .formatted(episodeId, seasonId, animeId));
  }

  @DeleteMapping("/animes/{animeId}/seasons/{seasonId}/episodes/{episodeId}")
  public ResponseEntity<String> deleteEpisode(
      @PathVariable Long animeId, @PathVariable Long seasonId, @PathVariable Long episodeId) {

    service.removeEpisode(animeId, seasonId, episodeId);
    return ResponseEntity.ok(
        "Episode id %d deleted successfully in Season id %d of Anime id %d"
            .formatted(episodeId, seasonId, animeId));
  }
}
